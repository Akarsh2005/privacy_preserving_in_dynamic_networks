...
input_file = r"BIH_Results\merged_modified_snapshots.ncol"
# The directory where you want the results to be saved.
# I've cleaned up the path slightly (removed the extra '\\').
output_path = r"C:\Users\91936\OneDrive\Desktop\KM\angel"
...
aa = a.ArchAngel(
    ...
    threshold=0.35,  # Merging threshold for Angel
    match_threshold=0.35,  # Matching threshold between snapshots
    min_comsize=3,
    save=True,
